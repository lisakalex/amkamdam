...
class TestNewsUpdater(unittest.TestCase):
    ...
    def test_replace_text(self):
        with patch('NewsUpdater.BeautifulSoup', MockBeautifulSoup):
            with patch('NewsUpdater.NewsUpdater.load_news_api') as mock_load:
                with patch('NewsUpdater.NewsUpdater.filter_articles') as mock_filter:
